<?php
/**
 * Evaluation Template create view
 */
?>
<div class="row">
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Create Evaluation Template</h4>
                <p class="card-description">
                    Add a new evaluation template to the system
                </p>
                ...
                <form class="forms-sample" method="POST" action="<?= base_url('evaluation_template/create'); ?>">
                    ...
                    <button type="submit" class="btn btn-primary mr-2">Create Template</button>
